...
const unobserve = observeDom("[class^=\"channelTextArea\"] [class^=\"buttons\"]", (node) => {
	...
	const meowIcon = (() => {
		const _el$2 = (0, import_web$6.getNextElement)(_tmpl$2);
		(0, import_web$4.use)(tooltip, _el$2, () => "meow :3");
		(0, import_web$5.addEventListener)(_el$2, "click", handleClick(), true);
		(0, import_web$3.insert)(_el$2, meowSvg);
